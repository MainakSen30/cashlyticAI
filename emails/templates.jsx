...
export default function EmailTemplate({
  userName="",
  type="budget-alert", //monthly-report / budget-alert
  data={}
}) {
      ...
      <Html>
        ...
        <Body style={styles.body}>
          <Container style={styles.container}>
            ...
            {data?.insights && (
              <Section style={styles.section}>
                <Heading style={styles.heading}>CashlyticAI Insights</Heading>
            ...
            <Text style={styles.footer}>
              Thank you for using CashlyticAI. Keep tracking your finances for better
              financial health!
            </Text>
          </Container>
        </Body>
